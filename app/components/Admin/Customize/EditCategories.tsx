        ...
        <>
            {
                isLoading ? (
                    ...
                    <div className="mt-[120px] text-center">
                        ...
                        <div className={`${style.button} !w-[100px] !rounded absolute bottom-12 left-12 !min-h-[40px] !h-[40px] dark:text-[#fff] text-[#333] bg-[#cccccc34] ${areCategoriesUnChanged(data.layout.categories, categories) || isAnyCategoriesEmpty(categories) ? '!cursor-not-allowed' : '!cursor-pointer !bg-[#42d383]'
